...
export function SiteliyoContactPage({
  siteSettings,
}: {
  ...
  const formCardClass = isLightTheme
    ? "rounded-[18px] border border-[hsl(var(--border))] bg-[hsl(var(--surface))] p-6 text-[hsl(var(--foreground))] shadow-[0_18px_50px_rgba(23,23,23,0.06)] lg:p-7"
    : "rounded-[18px] border border-[hsl(var(--border))] bg-[hsl(var(--surface))] p-6 text-[hsl(var(--foreground))] lg:p-7";
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-[26px]">
          ...
          <section className={`${sectionBorderClass} py-16 lg:py-20`}>
            <div className="mx-auto max-w-[1040px] text-center">
              ...
              <h1 className={headingClass}>{copy.contact.title}</h1>
              <p className={bodyClass}>{copy.contact.description}</p>
            </div>
            ...
            <PublicContactForm
              ...
              className="mx-auto mt-12 max-w-[620px] lg:max-w-[740px]"
          ...
          <section className={`${sectionBorderClass} py-12 lg:py-0`}>
            <div className="grid lg:grid-cols-[0.4fr_0.6fr]">
              <div className={`${sectionBorderClass} px-6 py-10 lg:border-b-0 lg:border-r lg:px-8 lg:py-16`}>
                ...
                <h2 className={faqTitleClass}>{copy.contact.faqTitle}</h2>
              </div>
